        ...
        <div className='clearfix'>
          ...
          <div className='float-right'>
            ...
            <p className='text-muted mt-3'>
              <i className={this.props.classNameI} aria-hidden='true' /> {this.props.soustitre}
            </p>
            <div className=''>
              {this.props.progressbar
                ? <div className='progress progress-slim'>
                  <div className='progress-bar bg-warning-gadient' role='progressbar' aria-valuenow='25' aria-valuemin='0' aria-valuemax='100' />
                </div>
                : null
                  }
            </div>
            <Button type='submit' className='btn btn-success mr-2' label={this.props.label} />
          </div>
