        ...
        <ul className='nav'>
          <li className='nav-item nav-profile'>
            <div className='nav-link'>
              <div className='profile-image'> <img src={this.props.icon} alt='image' /> <span className='online-status online' /> </div>
          ...
          {this.props.options && this.props.options.map((o) => <MenuItem id={o.id} className='nav-link' href={o.href} icon={o.image} label={o.titre} />
          )}
