...
class HorizontalNav extends Component {
  ...
  <div className="navbar-menu-wrapper d-flex align-items-center">
    <ul className="navbar-nav navbar-nav-right header-links d-none d-md-flex">
      <MenuItem href="/" classNameFilter="mdi mdi-image-filter" label="Paramètres" />
      <MenuItem className="active" href="/" classNameFilter="mdi mdi-email-outline" label="Déconnexion" />
    </ul>
      ...
      <li className="nav-item dropdown">
        ...
        <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
          ...
          <a className="dropdown-item preview-item">
            ...
            <MenuItem className='d-none d-lg-block' href='/' icon={face4} classNameImg='img-xs rounded-circle' />
          </ul>
          <Button className='navbar-toggler navbar-toggler-right d-lg-none align-self-center' type='button' datatoggle='offcanvas' classNameSpan='icon-menu' />
        </div>
      </nav>
    )
  }
